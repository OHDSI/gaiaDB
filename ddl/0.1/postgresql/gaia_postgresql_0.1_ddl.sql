...
CREATE TABLE @cdmDatabaseSchema.data_source (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.variable_source (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.attr_index (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.geom_index (
			...
			data_source_id numeric NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.attr_template (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @cdmDatabaseSchema.geom_template (
